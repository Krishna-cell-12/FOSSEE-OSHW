...
exports.FlameSensorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let FlameSensorElement = class FlameSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.ledPower = false;
        this.ledSignal = false;
        this.pinInfo = [
            { name: 'VCC', y: 14.6, x: 199, number: 1, signals: [(0, pin_1.VCC)()] },
            { name: 'GND', y: 24.3, x: 199, number: 2, signals: [(0, pin_1.GND)()] },
    ...
    render() {
      ...
      >
        ...
        ${ledPower &&
            (0, lit_1.svg) `<circle cx="153.2" cy="7.5" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
        <rect x="145" y="48.3" width="16.7" height="5.52" fill="#dae3eb" />
        <rect x="149" y="48.1" width="8.43" height="5.9" fill="#fffefe" />
        ${ledSignal &&
            (0, lit_1.svg) `<circle cx="153.2" cy="51.3" r="7" fill="#80ff80" filter="url(#ledFilter)" />`}
...
exports.FlameSensorElement = FlameSensorElement;
__decorate([
...
exports.FlameSensorElement = FlameSensorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-flame-sensor')
], FlameSensorElement);
