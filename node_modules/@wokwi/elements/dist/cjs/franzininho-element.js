...
exports.FranzininhoElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pins_female_1 = require("./patterns/pins-female");
const pin_1 = require("./pin");
const keys_1 = require("./utils/keys");
let FranzininhoElement = class FranzininhoElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.led1 = false;
        this.ledPower = false;
        ...
        this.pinInfo = [
            ...
            { name: 'PB4', x: 218.5, y: 42.5, signals: [(0, pin_1.analog)(2), { type: 'pwm' }] },
            { name: 'PB5', x: 218.5, y: 52.2, signals: [(0, pin_1.analog)(0)] },
            { name: 'PB3', x: 218.5, y: 61.7, signals: [(0, pin_1.analog)(3)] },
            { name: 'PB2', x: 218.5, y: 71.2, signals: [(0, pin_1.spi)('SCK'), (0, pin_1.i2c)('SCL'), (0, pin_1.analog)(1)] },
            { name: 'PB1', x: 218.5, y: 80.9, signals: [(0, pin_1.spi)('MISO'), { type: 'pwm' }] },
            { name: 'PB0', x: 218.5, y: 90.5, signals: [(0, pin_1.spi)('MOSI'), (0, pin_1.i2c)('SDA'), { type: 'pwm' }] },
    ...
    render() {
      ...
      >
        ...
        ${pins_female_1.pinsFemalePattern}
        ...
        ${ledPower &&
            (0, lit_1.svg) `<circle cx="33.6" cy="25.9" r="1.8" fill="#03f704" filter="url(#ledFilter)" />`}
        ...
        ${led1 &&
            (0, lit_1.svg) `<circle cx="38.35" cy="25.9" r="1.8" fill="#fcfd00" filter="url(#ledFilter)" />`}
        ...
        <g stroke-width=".1" paint-order="fill stroke">
          <circle
            ...
            @touchend=${() => this.leave()}
            @keydown=${(e) => keys_1.SPACE_KEYS.includes(e.key) && this.down()}
            @keyup=${(e) => keys_1.SPACE_KEYS.includes(e.key) && this.up()}
          />
        </g>
...
exports.FranzininhoElement = FranzininhoElement;
__decorate([
...
__decorate([
    (0, decorators_js_1.query)('#reset-button')
], FranzininhoElement.prototype, "resetButton", void 0);
exports.FranzininhoElement = FranzininhoElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-franzininho')
], FranzininhoElement);
