...
exports.HeartBeatSensorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let HeartBeatSensorElement = class HeartBeatSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 17.8, x: 87, number: 1, signals: [(0, pin_1.GND)()] },
            { name: 'VCC', y: 27.5, x: 87, number: 2, signals: [(0, pin_1.VCC)()] },
...
exports.HeartBeatSensorElement = HeartBeatSensorElement;
exports.HeartBeatSensorElement = HeartBeatSensorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-heart-beat-sensor')
