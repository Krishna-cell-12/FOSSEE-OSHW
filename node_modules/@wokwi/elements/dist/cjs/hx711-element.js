...
exports.HX711Element = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let HX711Element = class HX711Element extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'VCC', y: 55, x: 7, number: 1, signals: [(0, pin_1.VCC)()] },
            { name: 'DT', y: 36.3, x: 7, number: 2, signals: [] },
            { name: 'SCK', y: 46.2, x: 7, number: 3, signals: [] },
            { name: 'GND', y: 26.5, x: 7, number: 4, signals: [(0, pin_1.GND)()] },
        ];
    }
    get dimension() {
        switch (this.type) {
...
exports.HX711Element = HX711Element;
__decorate([
    (0, decorators_js_1.property)()
], HX711Element.prototype, "type", void 0);
exports.HX711Element = HX711Element = __decorate([
    (0, decorators_js_1.customElement)('wokwi-hx711')
], HX711Element);
