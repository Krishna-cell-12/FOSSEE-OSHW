...
exports.ILI9341Element = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let ILI9341Element = class ILI9341Element extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        ...
        this.pinInfo = [
            ...
            { name: 'CS', x: 67.5024, y: 287.2, signals: [(0, pin_1.spi)('SS')] },
            { name: 'RST', x: 77.1036, y: 287.2, signals: [] },
            { name: 'D/C', x: 86.7048, y: 287.2, signals: [] },
            { name: 'MOSI', x: 96.306, y: 287.2, signals: [(0, pin_1.spi)('MOSI')] },
            { name: 'SCK', x: 105.9072, y: 287.2, signals: [(0, pin_1.spi)('SCK')] },
            { name: 'LED', x: 115.5084, y: 287.2, signals: [] },
            { name: 'MISO', x: 125.1096, y: 287.2, signals: [(0, pin_1.spi)('MISO')] },
        ];
    }
    static get styles() {
        return (0, lit_1.css) `
...
exports.ILI9341Element = ILI9341Element;
__decorate([
...
exports.ILI9341Element = ILI9341Element = __decorate([
    (0, decorators_js_1.customElement)('wokwi-ili9341')
], ILI9341Element);
