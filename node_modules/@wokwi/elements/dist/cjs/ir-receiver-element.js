...
exports.IRReceiverElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let IRReceiverElement = class IRReceiverElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 87.75, x: 20.977, number: 1, signals: [(0, pin_1.GND)()] },
            { name: 'VCC', y: 87.75, x: 30.578, number: 2, signals: [(0, pin_1.VCC)()] },
...
exports.IRReceiverElement = IRReceiverElement;
exports.IRReceiverElement = IRReceiverElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-ir-receiver')
], IRReceiverElement);
