...
let KY040Element = class KY040Element extends lit_1.LitElement {
    constructor() {
        ...
        this.pinInfo = [
            ...
            { name: 'VCC', y: 36.3, x: 116, number: 4, signals: [(0, pin_1.VCC)()] },
            { name: 'GND', y: 45.5, x: 116, number: 5, signals: [(0, pin_1.GND)()] },
        ];
    }
    static get styles() {
        return (0, lit_1.css) `
...
exports.KY040Element = KY040Element = __decorate([
    (0, decorators_js_1.customElement)('wokwi-ky-040')
], KY040Element);
