...
let MembraneKeypadElement = class MembraneKeypadElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        /**
    ...
    renderKey(row, column) {
      ...
      @keydown=${(e) => keys_1.SPACE_KEYS.includes(e.key) && this.down(text, e.currentTarget)}
      @keyup=${(e) => keys_1.SPACE_KEYS.includes(e.key) && this.up(text, e.currentTarget)}
    >
...
exports.MembraneKeypadElement = MembraneKeypadElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-membrane-keypad')
