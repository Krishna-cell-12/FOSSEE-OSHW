...
exports.MicrosdCardElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let MicrosdCardElement = class MicrosdCardElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'CD', x: 76.734, y: 9.3744, signals: [] },
            { name: 'DO', x: 76.734, y: 18.8622, signals: [(0, pin_1.spi)('MISO')] },
            { name: 'GND', x: 76.734, y: 28.4634, signals: [{ type: 'power', signal: 'GND' }] },
            { name: 'SCK', x: 76.734, y: 38.178, signals: [(0, pin_1.spi)('SCK')] },
            { name: 'VCC', x: 76.734, y: 47.628, signals: [{ type: 'power', signal: 'VCC' }] },
            { name: 'DI', x: 76.734, y: 57.456, signals: [(0, pin_1.spi)('MOSI')] },
            { name: 'CS', x: 76.734, y: 66.906, signals: [(0, pin_1.spi)('SS')] },
        ];
    }
    render() {
        return (0, lit_1.html) `
...
exports.MicrosdCardElement = MicrosdCardElement;
exports.MicrosdCardElement = MicrosdCardElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-microsd-card')
], MicrosdCardElement);
