...
let NeoPixelElement = class NeoPixelElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.r = 0;
        this.g = 0;
        this.b = 0;
        this.pinInfo = [
            { name: 'VDD', y: 3.5, x: 1, number: 1, signals: [(0, pin_1.VCC)()] },
            { name: 'DOUT', y: 14, x: 1, number: 2, signals: [] },
            { name: 'VSS', y: 14, x: 21, number: 3, signals: [{ type: 'power', signal: 'GND' }] },
            { name: 'DIN', y: 3.5, x: 21, number: 4, signals: [(0, pin_1.GND)()] },
        ];
    }
    render() {
        const { r, g, b } = this;
...
exports.NeoPixelElement = NeoPixelElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-neopixel')
], NeoPixelElement);
