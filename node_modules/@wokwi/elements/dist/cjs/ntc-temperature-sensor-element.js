...
exports.NTCTemperatureSensorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let NTCTemperatureSensorElement = class NTCTemperatureSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 26.2, x: 135, number: 1, signals: [(0, pin_1.GND)()] },
            { name: 'VCC', y: 35.8, x: 135, number: 2, signals: [(0, pin_1.VCC)()] },
            { name: 'OUT', y: 45.5, x: 135, number: 3, signals: [(0, pin_1.analog)(0)] },
        ];
    }
    render() {
        return (0, lit_1.html) `
...
exports.NTCTemperatureSensorElement = NTCTemperatureSensorElement;
exports.NTCTemperatureSensorElement = NTCTemperatureSensorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-ntc-temperature-sensor')
