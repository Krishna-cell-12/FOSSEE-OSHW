...
exports.PIRMotionSensorElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let PIRMotionSensorElement = class PIRMotionSensorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'VCC', y: 92, x: 36.178, number: 1, signals: [(0, pin_1.VCC)()] },
            { name: 'OUT', y: 92, x: 45.9175, number: 2, signals: [] },
            { name: 'GND', y: 92, x: 55.6415, number: 3, signals: [(0, pin_1.GND)()] },
        ];
    }
    render() {
        return (0, lit_1.html) `
...
exports.PIRMotionSensorElement = PIRMotionSensorElement;
exports.PIRMotionSensorElement = PIRMotionSensorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-pir-motion-sensor')
