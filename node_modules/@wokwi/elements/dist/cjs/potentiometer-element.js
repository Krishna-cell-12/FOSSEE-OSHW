...
let PotentiometerElement = class PotentiometerElement extends lit_1.LitElement {
    constructor() {
        ...
        this.pinInfo = [
            ...
            { name: 'SIG', x: 39, y: 68.5, number: 2, signals: [(0, pin_1.analog)(0)] },
    ...
    renderSVG() {
        const percent = (0, clamp_1.clamp)(0, 1, this.percentFromMinMax(this.value, this.min, this.max));
    ...
    updateKnobMatrix() {
        ...
        this.pageToKnobMatrix =
            knob && workaroundElement
                ? (0, ctm_workaround_1.getScreenCTM)(knob, workaroundElement, new DOMRect(0, 9.5, 1, 1))
                : null;
    }
    rotateHandler(event) {
        event.stopPropagation();
        ...
        deg = (0, clamp_1.clamp)(this.startDegree, this.endDegree, deg);
    ...
    updateValue(value) {
        const clamped = (0, clamp_1.clamp)(this.min, this.max, value);
...
exports.PotentiometerElement = PotentiometerElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-potentiometer')
