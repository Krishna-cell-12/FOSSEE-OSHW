 ...
 */
let ResistorElement = class ResistorElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        /**
...
exports.ResistorElement = ResistorElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-resistor')
], ResistorElement);
