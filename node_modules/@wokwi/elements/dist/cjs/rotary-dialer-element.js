...
let RotaryDialerElement = class RotaryDialerElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', x: 122, y: 286, signals: [(0, pin_1.GND)()] },
    ...
    >
      ...
      <g transform="translate(1 1)">
        ...
        <path
          ...
          fill-opacity="0.5"
          fill="#D8D8D8"
          style=${(0, style_map_js_1.styleMap)(this.stylesMapping)}
        ></path>
      </g>
...
exports.RotaryDialerElement = RotaryDialerElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-rotary-dialer')
], RotaryDialerElement);
