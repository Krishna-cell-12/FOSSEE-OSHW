...
exports.SlidePotentiometerElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
const clamp_1 = require("./utils/clamp");
const ctm_workaround_1 = require("./utils/ctm-workaround");
const units_1 = require("./utils/units");
let SlidePotentiometerElement = class SlidePotentiometerElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
    ...
    get pinInfo() {
        return [
            ...
            { name: 'SIG', x: 1, y: 63, number: 2, signals: [(0, pin_1.analog)(0)] },
            {
                name: 'GND',
                x: 93.6 + this.travelLength * units_1.mmToPix,
                y: 43,
                number: 3,
    ...
    updateCaseDisplayProperties() {
        ...
        if (element && firefoxWorkaround) {
            this.pageToLocalTransformationMatrix = (0, ctm_workaround_1.getScreenCTM)(element, firefoxWorkaround, new DOMRect(0, 14, 1, 1));
        }
    ...
    updateValue(value) {
        this.value = (0, clamp_1.clamp)(this.min, this.max, value);
        this.dispatchEvent(new InputEvent('input', { detail: this.value }));
    }
};
exports.SlidePotentiometerElement = SlidePotentiometerElement;
__decorate([
...
exports.SlidePotentiometerElement = SlidePotentiometerElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-slide-potentiometer')
