...
let SSD1306Element = class SSD1306Element extends lit_1.LitElement {
    static get styles() {
        return (0, lit_1.css) `
      .container {
        position: relative;
    ...
    constructor() {
        ...
        this.ctx = null;
        this.pinInfo = [
            { name: 'DATA', x: 36.5, y: 12.5, signals: [(0, pin_1.i2c)('SDA')] },
            { name: 'CLK', x: 45.5, y: 12.5, signals: [(0, pin_1.i2c)('SCL')] },
    ...
    renderSVG() {
        ...
        return (0, lit_1.html) `<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg">
    ...
    render() {
        ...
        return (0, lit_1.html) ` <div class="container">
      ${this.renderSVG()}
...
exports.SSD1306Element = SSD1306Element = __decorate([
    (0, decorators_js_1.customElement)('wokwi-ssd1306')
], SSD1306Element);
