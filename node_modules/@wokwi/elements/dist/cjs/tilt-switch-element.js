...
exports.TiltSwitchElement = void 0;
const lit_1 = require("lit");
const decorators_js_1 = require("lit/decorators.js");
const pin_1 = require("./pin");
let TiltSwitchElement = class TiltSwitchElement extends lit_1.LitElement {
    constructor() {
        super(...arguments);
        this.pinInfo = [
            { name: 'GND', y: 18, x: 88, number: 1, signals: [(0, pin_1.GND)()] },
            { name: 'VCC', y: 27.8, x: 88, number: 2, signals: [(0, pin_1.VCC)()] },
...
exports.TiltSwitchElement = TiltSwitchElement;
exports.TiltSwitchElement = TiltSwitchElement = __decorate([
    (0, decorators_js_1.customElement)('wokwi-tilt-switch')
], TiltSwitchElement);
