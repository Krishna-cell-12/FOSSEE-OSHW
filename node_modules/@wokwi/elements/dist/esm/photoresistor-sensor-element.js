...
let PhotoresistorSensorElement = class PhotoresistorSensorElement extends LitElement {
    constructor() {
        super(...arguments);
        this.ledDO = false;
        this.ledPower = false;
...
PhotoresistorSensorElement = __decorate([
    customElement('wokwi-photoresistor-sensor')
], PhotoresistorSensorElement);
export { PhotoresistorSensorElement };
